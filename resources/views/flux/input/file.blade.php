...
@php
    $classes = Flux::classes()
        ->add('w-full flex items-center gap-4 flex-wrap overflow-hidden')
...
<div data-flux-input-file tabindex="0" {{ $styleAttributes->class($classes) }} wire:ignore x-data="fluxInputFile({ files: '{{ __('files') }}', noFile: '{{ __('common.file.none') }}' })"
